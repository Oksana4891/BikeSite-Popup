...
window.onload = function () {
  ...
  function bindModal(triggerSelector, modalSelector) {
    var triggers = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(".js-popup_close"); // Open popup
  ...
  function inputTime() {
    var btnOpen = document.querySelector(".popup-form_input--time"),
  ...
  function calcTotalPrice(selectorAllUnitPrice, selectorAllTotal, selectorTotalPrice) {
    var totalPrice = document.querySelector(selectorTotalPrice);
    var unitPrices = document.querySelectorAll(selectorAllUnitPrice);
    var total = document.querySelectorAll(selectorAllTotal);
    var decrementBtnAll = document.querySelectorAll('button[data-action="decrement"]');
    var incrementBtnAll = document.querySelectorAll('[data-action="increment"]');
    decrementBtnAll.forEach(function (decrementBtn) {
      return decrementBtn.addEventListener("click", function (e) {
        e.preventDefault();
        var parentBtn = e.target.parentNode;
        var inputCounter = parentBtn.querySelector('input');
        var inputCounterValue = +inputCounter.value;
    ...
    incrementBtnAll.forEach(function (incrementBtn) {
    ...
    function getTotalPrice() {
      ...
      for (i = 0; i < total.length; i += 1) {
        var valueUnitPrice = +unitPrices[i].textContent;
        var valueTotal = +total[i].value;
  ...
  function openGiftCert() {
    var trigger = document.querySelector('.js-gift-cert');
    var giftCert = document.querySelector('.gift-img');
    var closeGiftCert = document.querySelector('.js-close-gift-img');
    trigger.addEventListener('click', function (e) {
      e.preventDefault();
      giftCert.classList.add("is-open");
    });
    closeGiftCert.addEventListener('click', function (e) {
      e.preventDefault();
